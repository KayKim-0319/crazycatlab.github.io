...
const privacyTranslations = {
    en: {
        ...
        'privacy.thirdparty.remoteconfig.title': 'Google Firebase Remote Config',
        'privacy.thirdparty.remoteconfig.content': 'Some of our apps use Firebase Remote Config to receive remote settings such as promotions. This service may process:',
        'privacy.thirdparty.remoteconfig.item1': 'Device identifiers (installation ID)',
        'privacy.thirdparty.remoteconfig.item2': 'App version and language settings',
        'privacy.thirdparty.remoteconfig.note': 'Note: Remote Config only fetches settings from the server; it does not send app usage content.',
        ...
        'privacy.deviceid.sharing.firebase.label': 'Google (Firebase Analytics/Crashlytics/Remote Config):',
    ...
    ko: {
        ...
        'privacy.thirdparty.remoteconfig.title': 'Google Firebase Remote Config',
        'privacy.thirdparty.remoteconfig.content': '당사 앱 중 일부는 프로모션 등 원격 설정을 수신하기 위해 Firebase Remote Config를 사용합니다. 이 서비스는 다음을 처리할 수 있습니다:',
        'privacy.thirdparty.remoteconfig.item1': '기기 식별자 (설치 ID)',
        'privacy.thirdparty.remoteconfig.item2': '앱 버전 및 언어 설정',
        'privacy.thirdparty.remoteconfig.note': '참고: Remote Config는 서버에서 설정값을 받아오는 용도로만 사용되며, 앱 이용 내용을 전송하지 않습니다.',
